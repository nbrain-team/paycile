              ...
              <div class="ml-5 w-0 flex-1">
                <dl>
                  ...
                  <dd class="text-lg font-semibold text-gray-900">
                    {{ formatCurrency(summary()?.averageDailyBalance || 0) }}
                  </dd>
                </dl>
              </div>
            </div>
        ...
        <div class="grid grid-cols-7 gap-px bg-gray-200">
          ...
          <div *ngFor="let day of calendarDays()" 
            ...
            <div *ngIf="day" class="mt-1 space-y-1">
              <div *ngIf="day.totalIncome > 0" class="text-xs text-green-600 font-medium">
                +{{ formatCurrency(day.totalIncome) }}
              </div>
              <div *ngIf="day.totalExpenses > 0" class="text-xs text-red-600 font-medium">
